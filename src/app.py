...
from models import db, People, Planet, User, user_favorite_planets, user_favorite_characters
...
def get_user_favorites():
    ...
    if user.favorite_characters:
        favorite_characters = People.query.filter(People.id.in_(user.favorite_characters)).all()
